...
import { Newspaper, Images, BookOpen, Home, Building2, Calendar, FileCheck } from "lucide-react";
...
const navigation = [
  ...
  { name: "Applications", href: "/applications", icon: FileCheck, roles: ["admin", "finance", "visitor"] },
