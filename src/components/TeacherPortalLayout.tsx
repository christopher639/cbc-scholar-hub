                      ...
                      <TooltipTrigger asChild>
                        <SidebarMenuButton
                          ...
                          className={cn(
                            ...
                            isActive(item.path) && (useLightText 
          ...
          <header className="fixed top-0 left-0 right-0 md:left-auto z-50 w-full border-b border-border/30 bg-card/70 backdrop-blur-lg supports-[backdrop-filter]:bg-card/60">
            <div className="flex h-14 md:h-16 items-center justify-between px-4 md:px-6 gap-4 w-full">
              ...
              <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-1">
                ...
                {schoolInfo?.logo_url ? (
                  <div className="h-9 w-9 md:h-10 md:w-10 rounded-full overflow-hidden ring-2 ring-primary/20 flex-shrink-0 bg-background/20">
                    <img
                      src={schoolInfo.logo_url}
                      alt="School Logo"
                      className="h-full w-full object-contain p-1"
                  ...
                  <div className="h-9 w-9 md:h-10 md:w-10 rounded-full bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center ring-2 ring-primary/20 flex-shrink-0">
                    <GraduationCap className="h-4 w-4 md:h-5 md:w-5 text-primary-foreground" />
                  </div>
                )}

                <div className="min-w-0 flex-1">
                  <h1 className="text-xs sm:text-sm md:text-base font-bold leading-tight text-foreground truncate">
                    {schoolInfo?.school_name || "School Portal"}
                  </h1>
                  <p className="hidden md:block text-xs text-muted-foreground">
                    {schoolInfo?.motto || "Teacher Portal"}
                  </p>
                </div>
              </div>
