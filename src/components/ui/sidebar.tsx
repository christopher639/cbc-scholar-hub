...
>(({ defaultOpen = true, open: openProp, onOpenChange: setOpenProp, className, style, children, ...props }, ref) => {
  ...
  // Use lazy initializer to read from cookie only once
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile}>
        ...
        >
          <div 
            data-sidebar="sidebar"
            className={cn("flex h-full w-full flex-col overflow-y-auto bg-sidebar text-sidebar-foreground", className)}
          >
            {children}
          </div>
        </SheetContent>
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-track]:bg-sidebar-accent/20 [&::-webkit-scrollbar-thumb]:bg-sidebar-border [&::-webkit-scrollbar-thumb]:rounded-full",
        "hover:[&::-webkit-scrollbar-thumb]:bg-sidebar-primary/60",
        className,
      )}
      {...props}
    />
