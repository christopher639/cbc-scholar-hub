...
import { Plus, Trash2, Code, Loader2 } from "lucide-react";
            ...
            {loading ? (
              ...
              <div className="space-y-2">
                {learningAreas.map((area) => (
                  <div key={area.id} className="flex items-center justify-between p-4 border border-border rounded-lg bg-card hover:bg-muted/50 transition-colors">
