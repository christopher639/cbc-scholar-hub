            ...
            <div className="hidden lg:flex items-center gap-6 ml-4 pl-4 border-l border-border">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-foreground">{loading ? "..." : teachers.length}</p>
                </div>
              </div>
              <div className="flex items-center gap-2.5">
                <div className="p-2 bg-primary/10 rounded-lg">
                ...
                <div>
                  <p className="text-xs text-muted-foreground font-medium">With Subjects</p>
                  <p className="text-sm font-semibold text-foreground">{loading ? "..." : withAssignments}</p>
                </div>
              </div>
              <div className="flex items-center gap-2.5">
                <div className="p-2 bg-primary/10 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-foreground">{loading ? "..." : thisMonth}</p>
                </div>
              </div>
            </div>
          </div>
