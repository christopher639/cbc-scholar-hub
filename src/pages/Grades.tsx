    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-xl font-bold text-foreground">Grades & Streams</h1>
            <p className="text-sm text-muted-foreground">Filter by grade and stream to manage learners</p>
          </div>
